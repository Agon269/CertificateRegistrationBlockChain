pragma solidity >=0.4.22 <0.9.0;contract Certification {
    ...
    function getCertificate() public view returns (string memory, uint256,string memory, string memory, string memory, string memory) {
